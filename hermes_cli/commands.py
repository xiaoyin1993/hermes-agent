...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("undo", "撤销最近一轮用户/助手对话", "Session"),
    CommandDef("title", "为当前会话设置标题", "Session",
               args_hint="[name]"),
    CommandDef("branch", "分支当前会话（探索不同方向）", "Session",
    ...
    CommandDef("approve", "批准待执行的危险命令", "Session",
               gateway_only=True, args_hint="[session|always]"),
    CommandDef("deny", "拒绝待执行的危险命令", "Session",
               gateway_only=True),
    CommandDef("background", "在后台运行提示", "Session",
               aliases=("bg",), args_hint="<prompt>"),
    CommandDef("btw", "临时附带提问（使用会话上下文，无工具，不保存）", "Session",
               args_hint="<question>"),
    CommandDef("agents", "显示活跃代理和运行中的任务", "Session",
               aliases=("tasks",)),
    CommandDef("queue", "将提示加入队列等待下一轮（不中断当前任务）", "Session",
               aliases=("q",), args_hint="<prompt>"),
    CommandDef("status", "显示会话信息", "Session"),
    CommandDef("profile", "显示当前配置文件名称和主目录", "Info"),
    ...
    CommandDef("config", "显示当前配置", "Configuration",
               cli_only=True),
    CommandDef("model", "切换本次会话的模型", "Configuration", args_hint="[model] [--provider name] [--global]"),
    ...
    CommandDef("verbose", "循环切换工具进度显示：关 → 新 → 全部 → 详细",
    ...
    CommandDef("fast", "切换快速模式 — OpenAI 优先处理 / Anthropic 快速模式", "Configuration",
               args_hint="[normal|fast|status]",
               subcommands=("normal", "fast", "status", "on", "off")),
    CommandDef("skin", "显示或更换显示皮肤/主题", "Configuration",
               args_hint="[name]"),
    ...
    CommandDef("reload-mcp", "从配置文件重新加载 MCP 服务器", "Tools & Skills",
               aliases=("reload_mcp",)),
    CommandDef("browser", "通过 CDP 连接浏览器工具到你的 Chrome", "Tools & Skills",
    ...
    CommandDef("restart", "优雅重启网关（等待活跃任务完成后重启）", "Session",
               gateway_only=True),
    CommandDef("usage", "显示当前会话的 Token 用量和速率限制", "Info"),
    CommandDef("insights", "显示使用分析和统计", "Info",
               args_hint="[days]"),
    CommandDef("platforms", "显示网关/消息平台状态", "Info",
               cli_only=True, aliases=("gateway",)),
    CommandDef("copy", "复制最近一条助手回复到剪贴板", "Info",
               cli_only=True, args_hint="[number]"),
    CommandDef("paste", "从剪贴板粘贴图片", "Info",
               cli_only=True),
    CommandDef("image", "附加本地图片文件到下一条提示", "Info",
               cli_only=True, args_hint="<path>"),
    CommandDef("update", "更新 Hermes Agent 到最新版本", "Info",
               gateway_only=True),
